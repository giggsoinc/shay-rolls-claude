...
## Live Config
!`cat .shay-rolls/manifest.json 2>/dev/null | python3 -c "import json,sys; d=json.load(sys.stdin); print('Stack:', d['stack']['language'], '| Cloud:', d['stack']['cloud'], '| DB:', d['stack']['db'])"`

## Planning sequence (mandatory — no skipping)
1. Read .shay-rolls/architecture.md — understand current system
